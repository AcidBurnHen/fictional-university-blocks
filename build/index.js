...
class Like {
  ...
  ourClickDispatcher(e) {
    ...
    if (currentLikeBox.attr('data-exists') == 'yes') {
      /* .data attribute is only sent at page load, for interactivity use .attr  */
      this.deleteLike(currentLikeBox);
      /* Passes along the currentlikebox var to the other method */
    } else {
  ...
  createLike(currentLikeBox) {
    /* Passed on var needs to be mentioned */
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      /* Sends data to hook up with server side, adds ?professorId=?? to api ULR uses currentLikeBox to fetch id*/
      success: response => {
        currentLikeBox.attr('data-exists', 'yes');
        var likeCount = parseInt(currentLikeBox.find(".like-count").html(), 10);
        /*parseInt is a JS tool that converts string to text */
